      ...
      <div class="row">
        <div class="col justify-content-center">
          <div class="card mx-auto">
            <h1 class="text-center text-primary">Forgot Username</h1>
            <div class="card-body">
              <?php
              ...
              <form action="fpemailAuth.php" method="post">
               <div class="form-group">
                 <div class="row">
                   <div class="col-12">
                     <fieldset>
                       <legend><h5 class="text-primary">Enter the Email</h5></legend>
                         <input type="email" class="email-input form-control" name="fuemail" required placeholder="me@example.com">
                          </fieldset>
                   </div>
                     </div>
               </div>
